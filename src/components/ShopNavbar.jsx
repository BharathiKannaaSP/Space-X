...
// import { Container, Navbar, Nav, Form, FormControl,  Badge } from 'react-bootstrap'
...
//   <Container fluid>
//     <Navbar.Brand href="#">
//     <div onClick={()=>navigate('/')} className='navbar-logo' style={{fill:'white',cursor:'pointer'}}>
...
//           className="m-auto "
//           style={{ marginTop :'20px',width:'500px',textAlign:'start'}}
//           aria-label="Search"
//         />
//         <AiOutlineSearch style={{marginTop:'10px',cursor:'pointer'}} color='white' size={30}/>
//       </Form>
//       <Nav>
//        <Dropdown>
//         <Dropdown.Toggle style={{backgroundColor:'transparent'}} id="dropdown-basic">
//           <FaShoppingCart style={{fontSize:'20px'}}/>
//         <Badge style={{backgroundColor:'transparent'}}>{10}</Badge>
//         </Dropdown.Toggle>
//         <Dropdown.Menu>
