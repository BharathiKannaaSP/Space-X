    ...
    <div className={!scrolled ? 'homenavbar' : 'homenavbar_scrolled'}>
      <div className='navbar-container'>
       ...
       <div className='nav-links'>
        <a href='' onClick={()=>navigate('/falcon9')}>FALCON 9</a> 
        <a href='' onClick={()=>navigate('/falconheavy')}>FALCON HEAVY</a>
       ...
       <button onClick={()=>navigate('/userprofile')} className='userprofile' >{user.email}</button>
